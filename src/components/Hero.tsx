 ...
 * El video se difiere un frame tras el montaje para no competir con el LCP
 * del texto; bajo prefers-reduced-motion no se carga en absoluto.
 */
export default function Hero() {
  ...
  return (
    <section className="relative isolate flex min-h-[100dvh] flex-col justify-end overflow-hidden bg-ink text-text-light">
      {/* Capa de fondo: video o, si el usuario prefiere menos movimiento, resplandor estático. */}
